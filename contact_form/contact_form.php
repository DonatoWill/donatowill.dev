...
// configure
$from = 'donato_will@hotmail.com'; // Replace it with Your Hosting Admin email. REQUIRED!
$sendTo = 'donato_will@hotmail.com'; // Replace it with Your email. REQUIRED!
...
if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])):
    ...
    $secret = 'AIzaSyBSGm6Gc1VcXiZ6M-jzxAM-fPG6F-rg-r8';
